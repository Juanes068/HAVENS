...
# If EMAIL_HOST is not provided, defaults to Django console backend for safe development.
_DEFAULT_BACKEND = (
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Havens <joinhavens@gmail.com>') #TODO TODO:change the email adress
